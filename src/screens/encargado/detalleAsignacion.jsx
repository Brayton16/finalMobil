        ...
        <ScrollView contentContainerStyle={styles.container}>
                ...
                <View style={styles.card}>
                    ...
                    {detalleAsignacion.recursos.map((recurso, index) => (
                        <TouchableOpacity 
                            ...
                            onPress={() => Linking.openURL(recurso)} // 📌 Abre en el navegador
                        >
            ...
            <View style={styles.card}>
                ...
                {entrega ? (
                        ...
                        <View>
                            <Text style={styles.info}>📜 Estado: Pendiente</Text>
                            <Text style={styles.info}>📊 Calificación: Pendiente</Text>
                            <Text style={styles.info}>📝 Retroalimentación: Sin comentarios</Text>
                        </View>
                ) : (
